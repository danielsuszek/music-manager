...
use MusicManager\ManageBundle\Form\BandType;
...
class BandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MusicManagerManageBundle:Band')->findAll();

        return $this->render('MusicManagerManageBundle:Band:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MusicManagerManageBundle:Band:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MusicManagerManageBundle:Band')->find($id);
        ...
        return $this->render('MusicManagerManageBundle:Band:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MusicManagerManageBundle:Band:edit.html.twig', array(
            'entity'      => $entity,
